<!-- ski-admin-web/src/views/reports/ReportList.vue -->
<template>
  <div class="report-list">
    ...
    <el-table :data="reportList" border>
      ...
      <el-table-column prop="originalFilename" label="视频文件名" />
    ...
    <!-- 详情抽屉 -->
    <el-drawer :visible="detailVisible" direction="rtl" title="报告详情">
      <div v-if="detailData" class="report-detail">
        <div class="detail-header">
          ...
          <div class="info-row">
            ...
            <span>{{ detailData.originalFilename }}</span>
          </div>
          <div class="info-row">
          ...
          <div class="info-row">
            ...
            <span>输入 {{ detailData.llmInputTokens }} / 输出 {{ detailData.llmOutputTokens }}</span>
          </div>
        </div>
