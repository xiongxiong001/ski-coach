...
CREATE TABLE analysis_tasks (
    ...
    user_id             BIGINT        NOT NULL                COMMENT '用户ID',
    task_type           VARCHAR(20)   NOT NULL                COMMENT '任务类型: single / comparison',
    ...
    report_id           BIGINT        DEFAULT NULL            COMMENT '关联的报告ID',
...
CREATE TABLE reports (
    ...
    llm_cost_yuan       DECIMAL(10,6) DEFAULT NULL            COMMENT 'LLM调用花费(元)',
    llm_input_tokens    INT           DEFAULT NULL            COMMENT 'LLM输入token数',
    llm_output_tokens   INT           DEFAULT NULL            COMMENT 'LLM输出token数',
    created_time        DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP                          COMMENT '创建时间',
    update_time         DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
